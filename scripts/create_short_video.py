...
def parse_args():
    ...
    parser.add_argument("--output", default="videos/generated/valentina_sol_lifestyle_short.mp4")
    parser.add_argument("--srt", default="videos/generated/valentina_sol_lifestyle_short.srt")
    parser.add_argument("--concat", default="videos/generated/valentina_sol_lifestyle_concat.txt")
